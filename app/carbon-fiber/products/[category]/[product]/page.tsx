      ...
      <section className="pt-32 pb-6 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-neutral-400">
            ...
            <span>/</span>
            <Link href="/carbon-fiber" className="hover:text-neutral-700">Carbon Fiber</Link>
            <span>/</span>
            <Link href={`/carbon-fiber/products/${category.slug}`} className="hover:text-neutral-700">
              {category.name}
            </Link>
            <span>/</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-2">
            {product.applications.map((app) => (
              <span
                key={app}
                className="px-4 py-2 bg-carbon-primary/5 text-neutral-700 text-sm rounded-full"
              >
                {app}
              </span>
            ))}
